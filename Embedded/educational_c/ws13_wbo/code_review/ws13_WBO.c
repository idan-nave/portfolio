...
#include <stdio.h>  		/* standard input/output */ /*TODO: just the use - like printf()*/ 
#include <stdlib.h> 		/* malloc(), free() */
#include <string.h>             /* string manipulation */ /*TODO : just the use - like strlen()*/ 
...
err_code_ty err = NO_ERROR; /*TODO: change the err to result (liel said at my interview)*/
...
{
    size_t i = 0;
    long mask_word = 0U;/*TODO: delete the u*/
    mask_word |=  c;
