...
and the bytes are then copied from the temporary array to dest. */ /*TODO:rong discription, you didn't use temporary array, make it a smaller discription*/
...
/*  Memset:
    ...
    /*TODO: very nice but we must ask liel if we can put the requirements in the header*/
