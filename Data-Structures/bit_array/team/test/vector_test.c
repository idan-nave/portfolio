...
void TestVector()
{
	...
	vector_ty *my_vector_chars = VectorCreate(CAPACITY_TEST,1);
	vector_ty *my_vector_ints = VectorCreate(CAPACITY_TEST,4);
	vector_ty *my_vector_duobles = VectorCreate(CAPACITY_TEST,8);
	int i = 0;
